                    ...
                    <div class="dashboard-left-sidebar">
                        ...
                        <div class="profile-box">
                            <div class="cover-image">
                                <img src="{{asset('fontend/assets/images/inner-page/cover-img.jpg')}}" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                            ...
                            <div class="profile-contain">
                                <div class="profile-image">
                                    <div class="position-relative">
                                        <img src="{{asset('fontend/assets/images/inner-page/user/1.jpg')}}"
                                    ...
                                    <div class="title">
                                        ...
                                        <span class="title-leaf">
                                            <svg class="icon-width bg-gray">
                                                <use xlink:href="{{asset('fontend/assets/svg/leaf.svg#leaf')}}"></use>
                                            </svg>
                                        </span>
                                    </div>
                                        ...
                                        <div class="row g-sm-4 g-3">
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="{{asset('fontend/assets/images/svg/order.svg')}}"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{asset('fontend/assets/images/svg/order.svg')}}" class="blur-up lazyload"
                                                        alt="">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="{{asset('fontend/assets/images/svg/pending.svg')}}"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{asset('fontend/assets/images/svg/pending.svg')}}" class="blur-up lazyload"
                                                        alt="">
                                                    <div class="totle-detail">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="{{asset('fontend/assets/images/svg/wishlist.svg')}}"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{asset('fontend/assets/images/svg/wishlist.svg')}}"
                                                ...
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="{{asset('fontend/assets/images/cake/product/2.png')}}"
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="{{asset('fontend/assets/images/cake/product/3.png')}}"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="{{asset('fontend/assets/images/cake/product/4.png')}}"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="{{asset('fontend/assets/images/cake/product/5.png')}}"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="{{asset('fontend/assets/images/cake/product/6.png')}}"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="{{asset('fontend/assets/images/cake/product/7.png')}}"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                ...
                                <div class="dashboard-order">
                                    ...
                                    <div class="order-contain">
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="{{asset('fontend/assets/images/vegetable/product/2.png')}}" alt=""
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="{{asset('fontend/assets/images/vegetable/product/3.png')}}" alt=""
                                                        class="blur-up lazyload">
                                                </a>
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="{{asset('fontend/assets/images/payment-icon/1.jpg')}}"
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details card-visa">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="{{asset('fontend/assets/images/payment-icon/2.jpg')}}"
                                                                class="img-fluid blur-up lazyloaded" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details dabit-card">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="{{asset('fontend/assets/images/payment-icon/3.jpg')}}"
                                                                class="img-fluid blur-up lazyloaded" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="dashboard-profile">
                                    ...
                                    <div class="profile-about dashboard-bg-box">
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-5">
                                                <div class="profile-image">
                                                    <img src="{{asset('fontend/assets/images/inner-page/dashboard-profile.png')}}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            </div>
                                        </div>
