        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form enctype="multipart/form-data" action="{{route('product.update',$product->id)}}" method="POST" novalidate>
                            @csrf
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" data-validate-length-range="6" data-validate-words="2"
                                        name="name" value="{{$product->name}}" required="required"/>
                                </div>
                            </div>
                            <div class="field item form-group">
                             ...
                             <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" value="{{$product->descriptioin}}" class='optional' name="description"
                                     type="text" row="10"/>
                                </div>
                            </div>
                            <div class="ln_solid">
