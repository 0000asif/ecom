                    ...
                    <div class="x_content">
                        <form enctype="multipart/form-data" action="{{route('user.update',$user->id)}}" method="POST" novalidate>
                             ...
                             @foreach (json_decode($user->billing_address) as $key=>$address)
                              <div class="field item form-group" id="remove_b-{{$key}}">
                                ...
                                <div class="col-md-6 col-sm-6 input-group" role="group">
                                    ...
                                    @else
                                    <span class="btn btn-danger m-0 add-billing" onclick="removed_b({{$key}})">X</span>
                                    @endif
                            ...
                            @if (!empty(json_decode($user->shipping_address)))
                             ...
                             <div class="field item form-group" id="remove_s-{{$key}}">
                                ...
                                <div class="col-md-6 col-sm-6 input-group" role="group">
                                    ...
                                    @else
                                    <span class="btn btn-danger m-0 add-shipping" onclick="removed_s({{$key}})">X</span>
                                    @endif
                                </div>
                            </div>
...
<script>
        ...
        $('.add-billing').on('click', function() {
            ...
            let result = `
                <div class="field item form-group" id="remove_b-${count}">
                    ...
                    <span class="btn btn-danger m-0 add-billing" onclick="removed_b(${count})" >X</span>
                    </div>
                </div>
            `;
    ...
    $(document).ready(function() {
        $('.add-shipping').on('click', function() {
            ...
            let result = `
                <div class="field item form-group" id="remove_s-${count}">
                    ...
                    <span class="btn btn-danger m-0 add-shipping" onclick = "removed_s(${count})" >X</span>
                    </div>
                </div>
            `;
    ...
    function removed_s(count) {
        $('#remove_s-'+count).remove();
    }
</script>
@endpush
