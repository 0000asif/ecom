        ...
        <div class="row g-4">
            <div class="col-xl-8 ratio_65">
                <div class="home-contain h-100">
                    <div class="h-100">
                        <img src="{{ asset('fontend/assets/images/vegetable/banner/1.jpg') }}"
                ...
                <div class="row g-4">
                    <div class="col-xl-12 col-md-6">
                        <div class="home-contain">
                            <img src="{{ asset('fontend/assets/images/vegetable/banner/2.jpg') }}"
                                class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="col-xl-12 col-md-6">
                        <div class="home-contain">
                            <img src="{{ asset('fontend/assets/images/vegetable/banner/3.jpg') }}"
                                class="bg-img blur-up lazyload" alt="">
                            <div class="home-detail p-center-left home-p-sm w-75">
                                <div>
        ...
        <div class="banner-slider">
            <div>
                <div class="banner-contain hover-effect">
                    <img src="{{ asset('fontend/assets/images/vegetable/banner/4.jpg') }}"
                        class="bg-img blur-up lazyload" alt="">
            ...
            <div>
                <div class="banner-contain hover-effect">
                    <img src="{{ asset('fontend/assets/images/vegetable/banner/5.jpg') }}"
                        class="bg-img blur-up lazyload" alt="">
                    <div class="banner-details">
                        <div class="banner-box">
                            <h6 class="text-danger">5% OFF</h6>
            ...
            <div>
                <div class="banner-contain hover-effect">
                    <img src="{{ asset('fontend/assets/images/vegetable/banner/6.jpg') }}"
                        class="bg-img blur-up lazyload" alt="">
                    <div class="banner-details">
                        <div class="banner-box">
                            <h6 class="text-danger">5% OFF</h6>
            ...
            <div>
                <div class="banner-contain hover-effect">
                    <img src="{{ asset('fontend/assets/images/vegetable/banner/7.jpg') }}')}}"
                        class="bg-img blur-up lazyload" alt="">
                    <div class="banner-details">
                        <div class="banner-box">
                            <h6 class="text-danger">5% OFF</h6>
                ...
                <div class="p-sticky">
                    <div class="category-menu">
                        ...
                        <ul>
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('fontend/assets/svg/1/vegetable.svg') }}"
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('fontend/assets/svg/1/cup.svg') }}" class="blur-up lazyload"
                                        alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('fontend/assets/svg/1/meats.svg') }}" class="blur-up lazyload"
                                        alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('fontend/assets/svg/1/breakfast.svg') }}"
                                        class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('fontend/assets/svg/1/frozen.svg') }}"
                                        class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('fontend/assets/svg/1/biscuit.svg') }}"
                                        class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('fontend/assets/svg/1/grocery.svg') }}"
                                        class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('fontend/assets/svg/1/drink.svg') }}" class="blur-up lazyload"
                                        alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('fontend/assets/svg/1/milk.svg') }}" class="blur-up lazyload"
                                        alt="">
                                    <h5>
                            ...
                            <li class="pb-30">
                                <div class="category-list">
                                    <img src="{{ asset('fontend/assets/svg/1/pet.svg') }}" class="blur-up lazyload"
                                        alt="">
                                    <h5>
                        ...
                        <ul class="value-list">
                            ...
                            <li>
                                <div class="category-list">
                                    <h5 class="ms-0 text-title">
                                        <a href="shop-left-sidebar.html" 50 Offers</a>
                                    </h5>
                                </div>
                            </li>
                            <li class="mb-0">
                    ...
                    <div class="ratio_156 section-t-space">
                        <div class="home-contain hover-effect">
                            <img src="{{ asset('fontend/assets/images/vegetable/banner/8') }}"
                                class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="ratio_medium section-t-space">
                        <div class="home-contain hover-effect">
                            <img src="{{ asset('fontend/assets/images/vegetable/banner/11') }}"
                        ...
                        <div class="category-menu">
                            ...
                            <ul class="product-list border-0 p-0 d-block">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('fontend/assets/images/vegetable/product/23.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('fontend/assets/images/vegetable/product/24.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('fontend/assets/images/vegetable/product/25.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li class="mb-0">
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('fontend/assets/images/vegetable/product/26.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                            ...
                            <div class="review-box">
                                ...
                                <div class="review-profile">
                                    <div class="review-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/review/1') }}')}}"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </div>
            ...
            <div class="col-xxl-9 col-xl-8">
                    ...
                    <div>
                        ...
                        <span class="title-leaf">
                            <svg class="icon-width">
                                <use xlink:href="{{ asset('fontend/assets/svg/leaf') }}"></use>
                            </svg>
                        </span>
                                ...
                                <div class="row m-0">
                                        ...
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('fontend/assets/images/vegetable/product/1.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                    ...
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('fontend/assets/images/vegetable/product/2.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('fontend/assets/images/vegetable/product/3.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('fontend/assets/images/vegetable/product/4.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('fontend/assets/images/vegetable/product/5.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('fontend/assets/images/vegetable/product/6.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('fontend/assets/images/vegetable/product/7.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('fontend/assets/images/vegetable/product/8.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('fontend/assets/images/vegetable/product/9.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('fontend/assets/images/vegetable/product/10.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                ...
                <div class="category-slider-2 product-wrapper no-arrow">
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" class="category-box category-dark">
                            <div>
                                <img src="{{ asset('fontend/assets/svg/1/frozen.svg') }}" class="blur-up lazyload"
                                    alt="">
                                <h5>Frozen Foods</h5>
                            </div>
                        </a>
                ...
                <div class="section-t-space section-b-space">
                    <div class="row g-md-4 g-3">
                        <div class="col-md-6">
                            <div class="banner-contain hover-effect">
                                <img src="{{ asset('fontend/assets/images/vegetable/banner/9') }}"
                                    class="bg-img blur-up lazyload" alt="">
                        ...
                        <div class="col-md-6">
                            <div class="banner-contain hover-effect">
                                <img src="{{ asset('fontend/assets/images/vegetable/banner/10') }}"
                                    class="bg-img blur-up lazyload" alt="">
                                <div class="banner-details p-center-left p-4">
                                    <div>
                                        <h3 class="text-exo">50% offer</h3>
                ...
                <div class="section-t-space">
                    <div class="banner-contain">
                        <img src="{{ asset('fontend/assets/images/vegetable/banner/15.jpg') }}"
                            class="bg-img blur-up lazyload" alt="">
                ...
                <div class="section-t-space section-b-space">
                    <div class="row g-md-4 g-3">
                        <div class="col-xxl-8 col-xl-12 col-md-7">
                            <div class="banner-contain hover-effect">
                                <img src="{{ asset('fontend/assets/images/vegetable/banner/12.jpg') }}"
                                    class="bg-img blur-up lazyload" alt="">
                                <div class="banner-details p-center-left p-4">
                                    <div>
                        ...
                        <div class="col-xxl-4 col-xl-12 col-md-5">
                            <a href="shop-left-sidebar.html" class="banner-contain hover-effect h-100">
                                <img src="{{ asset('fontend/assets/images/vegetable/banner/13.jpg') }}"
                                    class="bg-img blur-up lazyload" alt="">
                ...
                <div class="title d-block">
                    <div>
                        ...
                        <span class="title-leaf">
                            <svg class="icon-width">
                                <use xlink:href="{{ asset('fontend/assets/svg/leaf#leaf') }}"></use>
                            </svg>
                        </span>
                        <p>A virtual assistant collects the products from your list</p>
                    </div>
                    ...
                    <div>
                        <ul class="product-list">
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/11.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/12.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/13.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/14.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                    ...
                    <div>
                        <ul class="product-list">
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/15.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/16.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/17.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/18.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                    ...
                    <div>
                        <ul class="product-list">
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/19.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/20.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/21.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li>
                                <div class="offer-product">
                                    <a href="product-left-thumbnail.html" class="offer-image">
                                        <img src="{{ asset('fontend/assets/images/vegetable/product/22.png') }}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                ...
                <div class="section-t-space">
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('fontend/assets/images/vegetable/banner/14.jpg') }}"
                            class="bg-img blur-up lazyload" alt="">
                ...
                <div class="slider-3-blog ratio_65 no-arrow product-wrapper">
                        ...
                        <div class="blog-box">
                            <div class="blog-box-image">
                                <a href="blog-detail.html" class="blog-image">
                                    <img src="{{ asset('fontend/assets/images/vegetable/blog/1.jpg') }}"
                                        class="bg-img blur-up lazyload" alt="">
                                </a>
                            </div>
                    ...
                    <div>
                        <div class="blog-box">
                            <div class="blog-box-image">
                                <a href="blog-detail.html" class="blog-image">
                                    <img src="{{ asset('fontend/assets/images/vegetable/blog/2.jpg') }}"
                                        class="bg-img blur-up lazyload" alt="">
                                </a>
                            </div>
                    ...
                    <div>
                        <div class="blog-box">
                            <div class="blog-box-image">
                                <a href="blog-detail.html" class="blog-image">
                                    <img src="{{ asset('fontend/assets/images/vegetable/blog/3.jpg') }}"
                                        class="bg-img blur-up lazyload" alt="">
                                </a>
                            </div>
...
<section class="newsletter-section section-b-space">
 ...
 {{-- Newsletter Section End --}}
    ...
    @include('fontend.include.modal.deal_box')
    {{-- Deal Box Modal End --}}
 @endsection
